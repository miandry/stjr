...
{
    public function parser($entity, $fields = [], $options = [])
    {
        if (is_object($entity) && method_exists($entity, 'getEntityTypeId')) {
            $entity_type = $entity->getEntityTypeId();
            return $this->loader_entity_by_type($entity, $entity_type, $fields, $options);
        }
        return [];
    }
    ...
    public function parserEntity($entity_type, $entity, $fields = [], $options = [])
    {
        return $this->loader_entity_by_type($entity, $entity_type, $fields, $options);
    }

    public function media_parser($item, $field = [], $options = [])
    {
        $entity_type = 'media';
        $media_array = $this->loader_entity_by_type($item, $entity_type, $field, $options);
        return $media_array;
    }
    ...
    public function profile_parser($item, $field = [], $options = [])
    {
        $entity_type = 'profile';
